export function VideoThumb({
  ...
  return (
    <div>
      <div
        onClick={onPlay}
        className={`relative h-[190px] overflow-hidden rounded-[14px] bg-[radial-gradient(circle_at_60%_30%,#0d4741,transparent_55%),linear-gradient(135deg,#0a3733,#062a26)] after:absolute after:inset-0 after:bg-[linear-gradient(transparent,#082e2c66)] after:content-[''] ${
